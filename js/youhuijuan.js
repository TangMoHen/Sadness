...
$.ajax({
    ...
    data:{
        user_id:data11111,
        coupons_receive_status:0
    },
    success:function (ResponseText) {
        has.yishiyong = ResponseText.data;
        console.log(has.yishiyong);
    }
});
var vm2 = new Vue({
    el:"#tab3",
...
$.ajax({
    ...
    data:{
        user_id:data11111,
        coupons_receive_status:2
    },
    success:function (ResponseText) {
        vm2.yiguoqi = ResponseText.data;
        console.log(vm2.yiguoqi);
    }
});